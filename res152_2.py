...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv3b1 = nn.ModuleList([nn.Conv2d(512,128,1,bias=False) for i in range(7)])
        self.conv3b2 = nn.ModuleList([nn.Conv2d(128,128,3,padding=1,bias=False) for i in range(7)])
        self.conv3b3 = nn.ModuleList([nn.Conv2d(128,512,1,bias=False) for i in range(7)])
        self.conv4b1 = nn.ModuleList([nn.Conv2d(1024,256,1,bias=False) for i in range(35)])
        self.conv4b2 = nn.ModuleList([nn.Conv2d(256,256,3,padding=1,bias=False) for i in range(35)])
        self.conv4b3 = nn.ModuleList([nn.Conv2d(256,1024,1,bias=False) for i in range(35)])
